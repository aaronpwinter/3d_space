...
class ThreeDApp:
    ...
    def _initialize(self) -> None:
        ...
        self._model = models.Cube(200,(255,50,50),location = Vector(-100,0,700),rotation=Rotation(0,0,0))
        self._model2 = Model(location = Vector(200,40,500))
        ...
        self._model3 = models.Cube(1000,(100,100,2555),location = Vector(0,0,2000),rotation=Rotation(0,0,0))
